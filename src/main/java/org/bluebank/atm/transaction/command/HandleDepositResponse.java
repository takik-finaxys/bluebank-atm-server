...
public class HandleDepositResponse extends AggregateRootCommand<Transaction> {
    private final UUID transactionId;
    private final BigDecimal amount;
    private final String cardNumber;

    public HandleDepositResponse(UUID sessionId,
    ...
    public void delegateToAggregateRoot(Transaction transaction) {
        transaction.handleDepositResponse(transactionId, amount, cardNumber);
    }
}
